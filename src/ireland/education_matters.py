...
# Config
# ----------------------------------------------------------
API_URL = "https://educationmatters.ie/wp-json/wp/v2/posts"

_DEFAULT_OUTPUT = Path(__file__).resolve().parents[2] / "data" / "training" / "ireland" / "education_matters.csv"

HEADERS = {
    "User-Agent": "Mozilla/5.0 (compatible; EducationMattersScraper/1.0)"
}
...
def scrape_education_matters(since_date=None, until_date=None, output_path=None, append=False):
    ...
    print("Starting Education Matters scrape (WP API)...")
...
if __name__ == "__main__":
    scrape_education_matters(output_path=_DEFAULT_OUTPUT)
